...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void test_all_ssd1306_functions(void) {
    ssd1306_Init();
    ...
    // Draw arc
    ssd1306_Fill(Black);
    ssd1306_DrawArc(64, 32, 30, 0, 180, White);  
    ssd1306_UpdateScreen();
    HAL_Delay(1000);

    // Draw arc with radius line
    ssd1306_Fill(Black);
    ssd1306_DrawArcWithRadiusLine(64, 32, 30, 45, 180, White);
    ssd1306_UpdateScreen();
    HAL_Delay(1000);
    ...
    // Draw rectangle
    ssd1306_Fill(Black);
    ssd1306_DrawRectangle(10, 10, 100, 50, White);
    ssd1306_UpdateScreen();
    HAL_Delay(1000);

    // Fill rectangle
    ssd1306_Fill(Black);
    ssd1306_FillRectangle(20, 20, 80, 40, White);
    ssd1306_UpdateScreen();
    HAL_Delay(1000);
}
/* USER CODE END 0 */
