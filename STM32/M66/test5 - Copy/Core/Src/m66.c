...
////		
////				HAL_UART_Transmit(huart_m66, (uint8_t*)((char)(0x06)), 1, 1000);
////		HAL_UART_Transmit(huart_m66, (uint8_t*)((char)(0x33)), 1, 1000);
////				HAL_UART_Transmit(huart_m66, (uint8_t*)((char)(0x06)), 1, 1000);
////		HAL_UART_Transmit(huart_m66, (uint8_t*)((char)(0x44)), 1, 1000);
////				HAL_UART_Transmit(huart_m66, (uint8_t*)((char)(0x06)), 1, 1000);
////		HAL_UART_Transmit(huart_m66, (uint8_t*)((char)(0x27)), 1, 1000);
////				HAL_UART_Transmit(huart_m66, (uint8_t*)((char)(0x06)), 1, 1000);
////		HAL_UART_Transmit(huart_m66, (uint8_t*)((char)(0x45)), 1, 1000);
//		uint8_t message_ucs2[] = {0x06,0x33,0x06,0x44,0x06,0x27,0x06,0x45};
//size_t message_len = sizeof(message_ucs2);

//HAL_UART_Transmit(huart_m66, message_ucs2, message_len, 1000);
//		
...
void m66_sms_send_farsi_full(const char *phone_ucs2, const uint8_t *message_ucs2, size_t message_len)
{
    ...
    // ????? ???? (??????) ?? ???? ???? — ???: ?? sizeof ?? message_len ??????? ??
    HAL_UART_Transmit(huart_m66, (uint8_t*)message_ucs2, message_len, 5000);
    HAL_Delay(50);
